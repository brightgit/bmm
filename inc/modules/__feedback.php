<?php
	...
	$abs_path = $_SERVER["DOCUMENT_ROOT"] . "/bmm";
	...
	define(FEEDBACK_URL, "http://".$_SERVER["HTTP_HOST"]."/bmm/inc/modules/feedback.php");
	define(NEWSLETTER_VIEW_URL, "http://".$_SERVER["HTTP_HOST"]."/bmm/inc/visualize_news.php");
	define(SUBSCRIPTION_REMOVE_URL, "http://".$_SERVER["HTTP_HOST"]."/bmm/inc/remove.php");
	define(LINK_REDIRECT_URL, "http://".$_SERVER["HTTP_HOST"]."/bmm/inc/link.php");
	...
	function base_path(){
		...
		//hard fix
		$base_dir = "/chroot/home/brightmi/brightminds.pt/html/bmm";
